...
function appendDailyEntry() {
  return appendEntry(SpreadsheetApp.getActive(),1);
}

function appendWeeklyEntry() {
  return appendEntry(SpreadsheetApp.getActive(),7);
}
